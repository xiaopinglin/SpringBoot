...
layui.use(['form','jquery',"layer"],function() {
    ...
    //公告层
    function showNotice(){
        $.post('/sys/notice/getShowNotice', {}, function(cont){
    		layer.open({
                type: 1,
                title: "系统公告",
                area: '300px',
                ...
                btn: ['确认'],
                moveType: 1,
                content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>'+cont+'</p></div>',
